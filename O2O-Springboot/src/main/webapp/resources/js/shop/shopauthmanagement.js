$(function(){
    // 该店铺下所有授权信息的url
    var listUrl = '/o2o/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=5';
    // 修改授权信息的url
    ...
    /**
     * 给<a>的click事件绑定上对应的方法，即点击带有edit的<a>就会跳转到授权编辑页面
     * 点击带有status的<a>就会去更新该授权信息的状态
     */
    $('.shopauth-wrap')
        .on(
            'click',
